...
box-shadow: 0px 0px 11px 0px rgba(0,0,0,0.75);padding:12px">
		<div style="min-height:380px">
        	...
        	<table style=" font-size:20px" class="table table-bordered">
                ...
                <tr><td><input onClick="sumar_envio()" id="envio2" type="radio" name="envio" ></td><td>Envío (3 Soles +)</td></tr>
            </table>
        </div>
        <div>
			<a href="../../index.php">
...
box-shadow: 0px 0px 11px 0px rgba(0,0,0,0.75);padding:15px">
		<div style="min-height:380px">
        	...
        	<table style=" font-size:20px" class="table table-bordered">
                ...
                <tr><td><input onClick="forma_pago('Transferencia')" onMouseOver="datos_transferencia()" id="pago2" type="radio" name="formapago"></td><td>Transferencia Bancaria <div id="transferencia" style="margin-top:10px; font-size:13px; display:none" class="alert alert-warning" role="alert">En proceso u.U</div></td></tr>
...
<footer style="margin-top:-10px" class="wow bounceInDown" data-wow-duration="1.5s">
	<p>Todos los derechos reservados Alfresco.com</p>
</footer>
