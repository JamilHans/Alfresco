...
<span style="font-size:40px; font-family:'Ceviche One', cursive; color:#F00"><?php echo $fila3['precio']; ?> Soles !!&nbsp;&nbsp;X&nbsp;&nbsp;
...
<footer class="wow bounceInDown" data-wow-duration="1.5s"><p>Todos los derechos reservados Alfresco.com</p></footer>
